# Generated by Powerlevel10k configuration wizard on 2025-06-07 at 12:55 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_BACKGROUND="#ebdbb2"
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND="#322e2c"
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND="#ebdbb2"
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND="#322e2c"
  ...
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND="#322e2c"
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%236F'   # green foreground
  ...
  # Icon color.
  typeset -g POWERLEVEL9K_VCS_VISUAL_IDENTIFIER_COLOR=238
  ...
  typeset -g POWERLEVEL9K_VCS_CLEAN_FOREGROUND=112
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_FOREGROUND=112
  ...
  typeset -g POWERLEVEL9K_ASDF_FOREGROUND=172
  ...
  typeset -g POWERLEVEL9K_PER_DIRECTORY_HISTORY_LOCAL_FOREGROUND=220
