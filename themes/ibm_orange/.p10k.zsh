...
() {
  ...
  typeset -g POWERLEVEL9K_BACKGROUND="#f79400"
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND="#f79400"
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND="#292929"
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local   modified='%236F'  # yellow foreground
  ...
  typeset -g POWERLEVEL9K_VCS_LOADING_VISUAL_IDENTIFIER_COLOR=238
  # Custom icon.
